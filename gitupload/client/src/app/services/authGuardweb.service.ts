...
@Injectable()
export class AuthGuardWebService implements CanActivate, CanActivateChild {
  ...
  canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot):boolean {
   ...
   let webregistration = this.EncryptionService.DecryptText(localStorage.getItem('webregistration'));

   if (webregistration != "registered")  {
