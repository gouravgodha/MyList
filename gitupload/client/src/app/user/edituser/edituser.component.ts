       ...
       console.log("Update Company  Type called.");
        ...
        this.userTypeService.updateUserTypes(updateformtype).subscribe(res => {
            ...
            if (res.status == 200) {   
                ...
                if(error_constraint == "user_email must be unique")
                {
                    error_constraint = "User email must be unique, this is already exist in our database";
                }
      ...
      getUserRollList() {
        ...
        this.userRoleService.getUserRoles().subscribe(res => {
            ...
            if (res.status == 200) {
                ...
                this.userrollTypesList=this.userrollTypesList.filter(item =>item.user_role_id!='1');
