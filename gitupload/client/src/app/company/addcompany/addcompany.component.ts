...
export class AddcompanyComponent implements OnInit {
 ...
 users:any;
  ...
  OnFileChange(event) {
    ...
    fd.append('Listed', this.FormType.controls["Listed"].value);
        ...
        this.companyTypeService.addcompanyTypes(fd).subscribe(res => {
            ...
            if (res.status == 200) {                
                ...
                this.toastr.success('<span class="now-ui-icons ui-1_bell-53"></span>Company Added Successfully.', '', {
                   timeOut: 2000,
                   closeButton: true,
                   enableHtml: true,
...
getBusinessTypeList() {
        ...
        this.businessTypeService.getBusinessTypes().subscribe(res => {
            ...
            if (res.status == 200) {
                ...
                {
                this.businessTypesList=this.businessTypesList.filter(item =>item.business_status=="Active");                    
                }  
